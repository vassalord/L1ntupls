...
void JetEffs() {
  ...
  // pert of code for ieta -16 - 16
   ...
   for (int delay = -4; delay <= 10; delay += 2) {
    ...
    h9->SetTitle(Form("Delayed Jet Efficiency vs Jet i#eta for QIE delay %d, E > 60 GeV (RAW)",delay));
...
for (int ieta = -16; ieta <=16; ieta++){
  ...
  // logic fg0 = 1 and ieta <= 8 for all
   ...
   TH1F *h47 = (TH1F*)f1->Get("TT_LLP_HB");
    ...
    TH1F *h78 = (TH1F*)f1->Get("JetEt_less5_delay-4");
    TH1F *h79 = (TH1F*)f1->Get("JetEt_less5_delay-2");
    TH1F *h80 = (TH1F*)f1->Get("JetEt_less5_delay0");
    TH1F *h81 = (TH1F*)f1->Get("JetEt_less5_delay2");
    TH1F *h82 = (TH1F*)f1->Get("JetEt_less5_delay4");
    TH1F *h83 = (TH1F*)f1->Get("JetEt_less5_delay6");
    TH1F *h84 = (TH1F*)f1->Get("JetEt_less5_delay8");
    TH1F *h85 = (TH1F*)f1->Get("JetEt_less5_delay10");
    
    TH1F *h86 = (TH1F*)f1->Get("JetEt_hwQual_less5_delay-4");
    TH1F *h87 = (TH1F*)f1->Get("JetEt_hwQual_less5_delay-2");
    TH1F *h88 = (TH1F*)f1->Get("JetEt_hwQual_less5_delay0");
    TH1F *h89 = (TH1F*)f1->Get("JetEt_hwQual_less5_delay2");
    TH1F *h90 = (TH1F*)f1->Get("JetEt_hwQual_less5_delay4");
    TH1F *h91 = (TH1F*)f1->Get("JetEt_hwQual_less5_delay6");
    TH1F *h92 = (TH1F*)f1->Get("JetEt_hwQual_less5_delay8");
    TH1F *h93 = (TH1F*)f1->Get("JetEt_hwQual_less5_delay10");
    
    h78->SetLineColorAlpha(kWhite, 1.);
    h78->SetTitle(Form("Delayed Jet Efficiency vs Jet E_{T}, i #eta <= 5 (RAW)"));
    ...
    h78->GetYaxis()->SetRangeUser(0.,0.06);
    ...
    char saveFile13[100];
    latex->DrawLatex(0.5, 0.9, cmsLabel);
    sprintf(saveFile13,"/afs/cern.ch/user/s/shoienko/CMSSW_12_6_0_pre1/src/HcalTrigger/Validation/PlotEffs/Plot/Jet_Et_less5_delay.pdf");
   ...
   // for jet ET and hwQual all delay
    ...
    TH1F *h98 = (TH1F*)f1->Get("JetEt_over5_delay-4");
    TH1F *h99 = (TH1F*)f1->Get("JetEt_over5_delay-2");
    TH1F *h100 = (TH1F*)f1->Get("JetEt_over5_delay0");
    TH1F *h101 = (TH1F*)f1->Get("JetEt_over5_delay2");
    TH1F *h102 = (TH1F*)f1->Get("JetEt_over5_delay4");
    TH1F *h103 = (TH1F*)f1->Get("JetEt_over5_delay6");
    ...
    h98->GetYaxis()->SetRangeUser(0.,0.06);
    ...
    char saveFile14[100];
    latex->DrawLatex(0.5, 0.9, cmsLabel);
    sprintf(saveFile14,"/afs/cern.ch/user/s/shoienko/CMSSW_12_6_0_pre1/src/HcalTrigger/Validation/PlotEffs/Plot/Jet_Et_over5_delay.pdf");
